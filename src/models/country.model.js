      ...
      .then((exists) => {
        if (!exists) {
          db.schema
            ...
            .then(() => console.log('Created country table'))
            .catch((e) => console.error('Error creating country table', e));
        }
      })
      .catch((e) => console.error('Error creating country table', e)); // eslint-disable-line no-console
  }

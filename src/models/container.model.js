  ...
  static get jsonSchema() {
    return {
      ...
      properties: {
        ...
        in_date: { type: ['string', 'null'], format: 'date-time' },
      ...
      .then((exists) => {
        if (!exists) {
          db.schema
            ...
            .then(() => console.log('Created container table'))
            .catch((e) => console.error('Error creating container table', e));
        }
      })
      .catch((e) => console.error('Error creating container table', e)); // eslint-disable-line no-console
  }
